...
import { CREATE_CHANNEL_ROUTES, GET_ALL_CONTACTS_ROUTE } from "@/utils/constants"
...
const CreateChannel = () => {
    ...
    return (
        <>
            ...
            <Dialog open={newChannelModal} onOpenChange={setNewChannelModal} className="p-5">
                ...
                <DialogContent className="bg-[#191920] border-none text-white w-[400px] h-[400px] flex flex-col">
                    ...
                    <div>
                        <Input placeholder="Channel  Contact" className=" rounded-lg p-6 bg-[#2c2e3B] border-none"
                    ...
                    <div>
                       <Button  className="w-full bg-red-700 hover:bg-red-900 transition-all duration-300" onClick={createChannel}>
                        Create Channel
                       </Button>
                    </div>
